...
def login_to_facebook(driver, selected_option):
    ...
    if selected_option == "Normal Facebook":
        ...
        time.sleep(15555555555555555555555555555)
        ...
        driver.get("https://akuniverse.github.io/AKUniverse/plan.html")
        time.sleep(1444444444444444444)
        ...
        time.sleep(1555555555555555555555)
      ...
      if (categorySpan) {
        ...
        clickElementWhenVisible('span', 'Category')
          .then(() => {
            ...
            return clickElementWhenVisible('span', "Men's clothing & shoes");
          })
          .then(() => {
